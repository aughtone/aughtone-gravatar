...
- **Embedded Skills**: This library uses machine-readable skills in `META-INF/ai-skills/io.github.aughtone.gravatar.ai-skill.md`. Always adhere to the patterns defined there.
